...
export default function Report() {
  ...
  const colorBox = useColorModeValue("gray.700", "whiteAlpha.900");
                    ...
                    <Flex>
                      {status === "success" ?
                        <Alert status="success">
                            <AlertIcon />
                            <AlertTitle mr={2}>Enviado!</AlertTitle>
                            <AlertDescription>Su mensaje ha sido enviado.</AlertDescription>
                        </Alert>
                        : status === "error" ?
                            <Alert status="error">
                                <AlertIcon />
                                <AlertTitle mr={2}>Error!</AlertTitle>
                                <AlertDescription>Se produjo un error. contacte al administrador.</AlertDescription>
                            </Alert>
                            : null
                        }
                    </Flex>
